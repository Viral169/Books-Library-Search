        ...
        <div class="row g-0">
          <div class="col-md-4">
            <img
              ...
              src="https://covers.openlibrary.org/b/id/${
                cover === undefined ? "10675600" : book.cover_i
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <hr />
              <h3 class="lead"><span class="fw-bold">Author : </span> ${
                author === undefined ? "Unknown" : author[0]
              }</h3>
              <p class="lead"><span class="fw-bold">Publisher : </span> ${
                publisher === undefined ? "Unknown" : publisher[0]
              }</p>

              <p class="card-text">
                <small class="text-muted">First Published : ${
                  publishYear === undefined ? "Unknown" : publishYear
                }</small>
              </p>
            </div>
          </div>
